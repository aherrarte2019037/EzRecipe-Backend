...
api.get('/saveRecipe/:idRecipe', md_authentication.ensureAuth, recipeController.saveRecipe);
api.get('/getIdRecipe/:idRecipe', md_authentication.ensureAuth, recipeController.getIdRecipe);
